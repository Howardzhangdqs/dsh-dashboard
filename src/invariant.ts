/**
 * Package-owned invariant companion for `dsh-dashboard`.
 * @module dsh-dashboard/invariant
 */

/* jscpd:ignore-start */
import type { Context } from './context-types.ts'

const PACKAGE_NAME = 'dsh-dashboard'

/** Cordis companion plugin name. */
export const name = 'dsh-dashboard-invariant'
