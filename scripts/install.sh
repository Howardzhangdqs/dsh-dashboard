#!/usr/bin/env bash
# =============================================================================
# dsh-dashboard 一键安装脚本（官方 CLI 方式，macOS / Linux / Windows Git Bash）
#
...
# - 回滚：dsh plugin --profile web remove dsh-dashboard，或把 profile 依赖
#   改回 "dsh-dashboard": "link:<路径>" 再 pnpm install。
# =============================================================================
set -euo pipefail
